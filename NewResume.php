		...
		<section id="form">
			...
			<form id="education-form" class="formblock hidden">
				<div class="ed_fields">
					...
					<p><label>Start Date</label><input type="text" id="datepicker" placeholder="Choose start date (MMYY)"/></p>
    				<p><label>Guaduation Date</label><input type="text" id="datepicker" placeholder="Choose (Estimated) Graduation Date (MMYY)"/></p>
			...
			<form id="work-form" class="formblock hidden">
				...
				<div class="w_fields">
					...
					<p><label>Start Date</label><input type="text" id="datepicker" placeholder="Enter start date"/></p>
    				<p><label>End Date</label><input type="text" id="datepicker" placeholder="Enter end date"/></p>
